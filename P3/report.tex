...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{genero_regression_cm.png}
  \caption{Matriz de confusión del dataset GENERO con regresión logística}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{genero_regression_pred.png}
...
\begin{figure*}
 \section{Código de regresión logística del dataset DEFAULT}
  ...
  \lstinputlisting[language=Python]{default_neighbors.py}
\end{figure*}

\begin{figure*}
  \section{Código de clasificación k-NN del dataset GENERO}
  \label{appendix:nn_genero}
  \lstinputlisting[language=Python]{genero_neighbors.py}
\end{figure*}

\begin{figure*}
  \section{Código de regresión logística del dataset DEFAULT}
  \label{appendix:reg_default}
  \lstinputlisting[language=Python]{default_regression.py}
\end{figure*}

\begin{figure*}
  \section{Código de regresión logística del dataset GENERO}
  \label{appendix:reg_genero}
  \lstinputlisting[language=Python]{genero_regression.py}
\end{figure*}
